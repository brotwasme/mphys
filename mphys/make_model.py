...
def make_model(names, bs, thicks, roughs, fig_i, data, show=False, mcmc=False):
    ...
    layers[0].thick.setp(vary=True, bounds=(50, 150))
    layers[0].sld.real.setp(vary=True, bounds=(4, 6))

    for layer in layers[1:]:
        layer.thick.setp(vary=True, bounds=(50, 150))
        layer.sld.real.setp(vary=True, bounds=(4, 6))
