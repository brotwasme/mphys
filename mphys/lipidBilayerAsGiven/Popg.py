...
class Popg:
    """
    Parameters for the POPG component of the bilayer.

    Parameters
    ----------
    name : str
        Name for the component (default='POPG').
    """
